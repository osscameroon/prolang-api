      ...
      <div className="px-12 py-12 w-1/2 mx-auto min-h-1/2 my-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <div className="flex justify-center mt-8">
          <Link href="mailto:tericcabel@yahoo.com?subject=Prolang website down">
            <a className="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white bg-blue-600 border border-transparent rounded-lg focus:outline-none" data-testid="lnk-email">
                Contact the admin
            </a>
          </Link>
        </div>
